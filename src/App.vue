  ...
  <header class="bg-[#ff0b34]  shadow-sm sticky top-0 z-10">
    <nav class="mx-auto mb-2 sm:mx-5 md:mx-24 px-4 sm:px-6 lg:px-8 py-1 md:py-4">
        ...
        <div class="flex items-center space-x-4">
          <div class="relative hidden md:block">
            <input type="search"
              ...
              placeholder="Search">
            <svg class="h-6 w-6 text-gray-100 ml-2 mt-2 stroke-current absolute top-0 left-0"
          ...
          <a href="#"
            ...
            <svg class="h-6 w-6 leading-none text-gray-100 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none"
      ...
      <div class="relative md:hidden">
        ...
        <svg class="h-6 w-6 text-gray-100 ml-2 mt-3 stroke-current absolute top-0 left-0"
          xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
        </svg>
